...
public class BoundedDepthGamer extends SampleGamer {
	...
	public Move stateMachineSelectMove(long timeout)
		...
		finishBy = (long) (timeout - (timeout - start)*0.25); //Finish with 25% of the available time remaining
		...
		if( stop > finishBy ) { //decrease our depth limit if we took too long
			...
			double timeUsed = (stop-start)*100.0/(timeout-start); //A percentage of the time used
